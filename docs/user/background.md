...
Modelblocks grew out of the principle of modularising the [building blocks of energy system models](https://doi.org/10.1088/2516-1083/ad371e "Pfenninger, 2024. Open code and data are not enough: understandability as design goal for energy system models") to allow research teams to share methodologies without prioritising a specific model or tool in particular.
Although each model has its own needs and characteristics, the data fed into models of the same domain is often quite similar.


## Challenges

Modelblocks started a response to challenges seen in energy modelling research and similar fields.
...
??? info "Compare modular and monolithic modelling approaches"
    ...
    === "Monolithic model"
        ...
        This version includes additional rules for transport and geopolitical regions.
